...
public class Colors {
    private String color; //define variables
    private String fill;
    ...
    public Paint getColor() {
        if(this.color.contains("gradient")){ //gradient behaviour
            String array[] = color.split("[(||,||)]"); //splitting gradient into deperate values
